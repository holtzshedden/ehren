...
export default function InvoicePage({params}:{params:Promise<{id:string}>}){
 ...
 <header className="invoice-head"><div><div className="invoice-brand">EHREN<br/>FELD</div><small>{d.issuer_name||"Rechnungssteller noch nicht konfiguriert"}</small></div><h1>{d.credit_note_for_id?"GUTSCHRIFT":d.document_type==="ZERO_RECEIPT"?"0-€-BELEG":"RECHNUNG"}</h1></header>
