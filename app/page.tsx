...
const kiosks = [
  {
    ...
    address: "Venloer Straße 270, 50823 Köln",
...
export default function EhrenPage() {
  ...
  return (
    <main className="ehren-page">
      <header className="ehren-header">
        <div className="header-inner">
          ...
          <nav className="main-nav" aria-label="Hauptnavigation">
            ...
            <button onClick={() => scrollTo("kaufen")}>
              Kaufen
            </button>
            ...
            <a
              ...
              aria-label="EHREN Pils auf Instagram"
            >
              <InstagramIcon />
            </a>
          </nav>
        ...
        <div className="beer-inner">
          <div className="beer-content">
            ...
            <p>
              Bier. Kein Manifest.
              <br />
              Hier brauch ich noch nen duften Satz.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* KAUFEN */}
      <section
        className="kaufen-section campaign-section"
        id="kaufen"
      >
        <img
          src="/images/buddies.png"
          alt="Kiosk in Ehrenfeld"
          className="kaufen-image campaign-image"
        />
